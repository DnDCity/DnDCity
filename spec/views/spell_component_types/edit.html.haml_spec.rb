...
describe "spell_component_types/edit" do
  before(:each) do
  ...
  it "renders the edit spell_component_type form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", spell_component_type_path(@spell_component_type), "post" do
